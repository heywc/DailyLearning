 ...
 * @LastEditTime: 2023-01-28 17:56:22
        ...
        <Layout style={{ minHeight: '100vh',minWidth:'800px' }}>
            <Sider collapsible collapsed={collapsed} onCollapse={value => setCollapsed(value)}>
                <div style={{textAlign:'center', padding:'10px'}}>
                    {
                        collapsed ? <img src={'https://source.1kmxc.com/static-web-new/common/logo/ygl_icon_logo.png'} alt="" style={{width:'18px',height:'18px',borderRadius:'50%'}}/> : <img src={logo} alt="" style={{width:'86px',height:'19px'}}/>
                    }
                </div>
